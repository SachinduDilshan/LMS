...
<nav class="navbar navbar-inverse">
    ...
    <h2>Add a Student</h2>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="fname" id="fullName" placeholder="Enter your full Name" required>
      </div>
      <div class="form-group">
        <label for="IName">Name with initials:</label>
        <input type="text" class="form-control" name="iname" id="IName" placeholder="Enter name with initials" required>
      </div>
      <div class="form-group">
        <label for="firstName">First Name:</label>
        <input type="text" class="form-control" name="onename" id="firstName" placeholder="Enter First Name" required>
      </div>
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="email" id="Email" placeholder="Enter your emai" required>
      </div>
      <div class="form-group">
        <label for="cityname">Nearest City:</label>
        <input type="text" class="form-control" name="ncity" id="nearCity" placeholder="Enter your nearest city" required>
      </div>

      <label for="cars">Choose a course:</label>
          <select name="course" id="course">
                     <option value="fit">FIT</option>
                     <option value="hit">Degree</option>
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="gname" id="guardian" placeholder="Enter your guardian name" required>
      </div><br><br>

      <input type="submit" style="text-align: center; margin-left: 490px; padding: 10px 60px; font-size: 20px;" class="btn btn-primary" name="registaion_submit"></button>
    </form>
  </div>
          ...
          <div class="row">
            <div class="footer-col">
              ...
              <ul>
                ...
                <li><a href="politic.html">Political</a></li>
